...
class BannerSlider {
  constructor() {
    ...
    this.slides = ["https://www.figma.com/api/mcp/asset/7c35b3b1-23af-4fe5-a598-ebddd749acb4"];
    this.currentSlide = 0;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 메뉴 스크롤러 초기화
  const newMenuScroller = new MenuScroller(".newMenu-items", ".newMenu-buttonLeft", ".newMenu-buttonRight");

  const bestMenuScroller = new MenuScroller(".bestMenu-items", ".bestMenu-buttonLeft", ".bestMenu-buttonRight");
